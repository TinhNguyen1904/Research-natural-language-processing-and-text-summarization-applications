...
Original file is located at
    https://colab.research.google.com/drive/1aGgXTl5xKkBQv7dhwkTrQEoInbtH9HrH
"""
...
# Sử dụng LexRank
#cách tiếp cận không giám sát để tóm tắt văn bản dựa trên việc cho điểm trọng tâm dựa trên biểu đồ của các câu.
#Ý chính là những câu “giới thiệu” những câu tương tự khác cho người đọc. Vì vậy, nếu một câu rất giống với nhiều câu khác, nó có thể sẽ là một câu có tầm quan trọng lớn.
summarizer = LexRankSummarizer()
#Tóm tắt tài liệu bằng 7 câu
summary = summarizer(parser.document, 7)

for sentence in summary:
    print(sentence)

#Sử dụng LSA - Dựa vào kĩ thuật tần số thuật ngữ với sự phân tách giá trị số ít để tóm tắt văn bản
...
## Phương pháp thay thế sử dụng từ dừng
...
for sentence in summarizer_lsa2(parser.document,7):
    print(sentence)